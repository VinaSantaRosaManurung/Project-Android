...
import com.vina.travel.model.HistoryModel;
import com.vina.travel.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String id_book = "", asal, jenis, tujuan, tanggal, dewasa, anak, riwayat, total;
    String email;
    TextView tvNotFound;
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan booking dari " + asal + " dengan jenis " + jenis + " pada tanggal " + tanggal + ". " +
                    "Jumlah pembelian tiket dewasa sejumlah " + dewasa + " dan tiket anak-anak sejumlah " + anak + ".";
