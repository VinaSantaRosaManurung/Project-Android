package com.vina.travel.activity;
...
import com.vina.travel.R;
import com.vina.travel.database.DatabaseHelper;
import com.vina.travel.session.SessionManager;
...
public class BookHotelActivity extends AppCompatActivity {
    ...
    SQLiteDatabase db;
    Spinner spinAsal, spinJenisKamar, spinDewasa, spinAnak;
    SessionManager session;
    String email;
    int id_book;
    public String sAsal, sJenisKamar, sTanggal, sDewasa, sAnak;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] jenis = {"Single Room", "Twin Room", "Double Room", "Family Room", "Triple Room"};
        final String[] dewasa = {"0", "1", "2", "3", "4", "5"};
        final String[] anak = {"0", "1", "2", "3", "4", "5"};

        spinAsal = findViewById(R.id.asal);
        spinJenisKamar = findViewById(R.id.jenis);
        ...
        ArrayAdapter<CharSequence> adapterJenisKamar = new ArrayAdapter<CharSequence>(this, android.R.layout.simple_spinner_item, jenis);
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                perhitunganHarga();
                if (sAsal != null && sJenisKamar != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("jakarta") && sJenisKamar.equalsIgnoreCase("Single Room"))
                            || (sAsal.equalsIgnoreCase("bandung") && sJenisKamar.equalsIgnoreCase("Twin Room"))
                            || (sAsal.equalsIgnoreCase("purwokerto") && sJenisKamar.equalsIgnoreCase("Double Room"))
                            || (sAsal.equalsIgnoreCase("yogyakarta") && sJenisKamar.equalsIgnoreCase("Family Room"))
                            || (sAsal.equalsIgnoreCase("surabaya") && sJenisKamar.equalsIgnoreCase("Triple Room"))) {
                        Toast.makeText(BookHotelActivity.this, "Harus diisi !", Toast.LENGTH_LONG).show();
                    } else {
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("jakarta") && sJenisKamar.equalsIgnoreCase("Single Room")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sJenisKamar.equalsIgnoreCase("Twin Room")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sJenisKamar.equalsIgnoreCase("Double Room")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sJenisKamar.equalsIgnoreCase("Family Room")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("bandung") && sJenisKamar.equalsIgnoreCase("Triple Room")) {
            hargaDewasa = 100000;
            hargaAnak = 70000;
        } else if (sAsal.equalsIgnoreCase("bandung") && sJenisKamar.equalsIgnoreCase("Twin Room")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("bandung") && sJenisKamar.equalsIgnoreCase("Double Room")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("bandung") && sJenisKamar.equalsIgnoreCase("Family Room")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sJenisKamar.equalsIgnoreCase("Triple Room")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sJenisKamar.equalsIgnoreCase("Single Room")) {
            hargaDewasa = 120000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sJenisKamar.equalsIgnoreCase("Double Room")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("surabaya") && sJenisKamar.equalsIgnoreCase("Family Room")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("purwokerto") && sJenisKamar.equalsIgnoreCase("Triple Room")) {
            hargaDewasa = 150000;
            hargaAnak = 120000;
        } else if (sAsal.equalsIgnoreCase("purwokerto") && sJenisKamar.equalsIgnoreCase("Twin Room")) {
            hargaDewasa = 120000;
            hargaAnak = 90000;
        } else if (sAsal.equalsIgnoreCase("purwokerto") && sJenisKamar.equalsIgnoreCase("Double Room")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("purwokerto") && sJenisKamar.equalsIgnoreCase("Family Room")) {
            hargaDewasa = 170000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("yogyakarta") && sJenisKamar.equalsIgnoreCase("Triple Room")) {
            hargaDewasa = 180000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("yogyakarta") && sJenisKamar.equalsIgnoreCase("Twin Room")) {
            hargaDewasa = 190000;
            hargaAnak = 160000;
        } else if (sAsal.equalsIgnoreCase("yogyakarta") && sJenisKamar.equalsIgnoreCase("Family Room")) {
            hargaDewasa = 80000;
            hargaAnak = 40000;
        } else if (sAsal.equalsIgnoreCase("yogyakarta") && sJenisKamar.equalsIgnoreCase("Double Room")) {
            hargaDewasa = 180000;
            hargaAnak = 150000;
        }
